...
export default function VolunteeringPage() {
  const description = "Partner with Floating Doctors, contribute supplies, and sponsor education while staying in Dolphin Bay.";
    ...
    <div className="space-y-0 pb-0 pt-0">
      ...
      <section className="section !py-6 bg-white">
        <div className="container max-w-4xl">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="italic lowercase text-sm md:text-base font-serif text-black">Volunteering</span>
            <div className="h-px w-8 bg-black"></div>
          </div>
        </div>
      </section>
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] max-h-[600px]">
        <Image
          ...
          alt="Volunteering and community support"
          fill
