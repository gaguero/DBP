  ...
  return (
    <div className="space-y-24 pb-24">
      <PageHero
        ...
        kicker="Plan"
        description="Our concierge team coordinates each leg of your travel-flights, drivers, and private boat transfers-to make your arrival effortless."
      ...
      <section className="section">
        <div className="container grid gap-8 md:grid-cols-3">
          {travelRoutes.map((route) => (
            <Card key={route.title} className="space-y-3">
              <h2 className="font-display text-xl text-[var(--color-navy)]">{route.title}</h2>
        ...
        <div className="container grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-start">
          ...
          <Card className="space-y-3">
            ...
            <p className="text-sm text-muted">
              Share your flight details and we&apos;ll coordinate transfers from Bocas Town or Tierra Oscura within our scheduled
              pick-up windows (12:30 pm and 5:00 pm). Late arrivals can be arranged with advance notice.
            </p>
      ...
      <LegacyContent
        page="plan"
        description="Legacy travel logistics guidance is archived in full below."
      />
    </div>
  );
}