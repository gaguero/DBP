      ...
      <div className="container py-12 space-y-24">
        ...
        <section className="component-demo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { icon: "🐬", title: "Dolphin Watching", image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=500&fit=crop" },
              { icon: "🤿", title: "Snorkeling", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=500&fit=crop" },
              { icon: "🚣", title: "Kayaking", image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=500&fit=crop" },
              { icon: "🌴", title: "Rainforest Hike", image: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&h=500&fit=crop" },
            ].map((activity, idx) => (
