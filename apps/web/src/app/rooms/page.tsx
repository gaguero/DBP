  ...
  return (
    <div className="space-y-24 pb-24">
      <PageHero
        ...
        kicker="Stay with us"
        description="Each accommodation is powered by solar energy, refreshed with purified rainwater, and curated with artisanal touches—ready for bespoke itineraries and mindful rest."
