 ...
 */
class CreateRecord extends WorkflowAction
{
    public function execute(Entity $targetEntity, array $actionData, Entity $execution): array
    {
        ...
        if (!$entity) {
            throw new Error("CreateRecord: Entity type '{$entityType}' not found");
        }
        
        // Resolve placeholders and set properties
