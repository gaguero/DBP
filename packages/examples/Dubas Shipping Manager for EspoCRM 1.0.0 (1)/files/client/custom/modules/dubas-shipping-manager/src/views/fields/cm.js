...
define('dubas-shipping-manager:views/fields/cm', 'views/fields/base', function (Dep) {

    return Dep.extend({

        type: 'cm',

        listTemplate: 'dubas-shipping-manager:fields/cm/list',

        detailTemplate: 'dubas-shipping-manager:fields/cm/detail',

        editTemplate: 'dubas-shipping-manager:fields/cm/edit',

        searchTemplate: 'dubas-shipping-manager:fields/cm/search',
