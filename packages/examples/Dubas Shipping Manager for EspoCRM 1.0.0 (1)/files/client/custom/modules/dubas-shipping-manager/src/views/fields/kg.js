...
define('dubas-shipping-manager:views/fields/kg', 'views/fields/base', function (Dep) {

    return Dep.extend({

        type: 'cm',

        listTemplate: 'dubas-shipping-manager:fields/kg/list',

        detailTemplate: 'dubas-shipping-manager:fields/kg/detail',

        editTemplate: 'dubas-shipping-manager:fields/kg/edit',

        searchTemplate: 'dubas-shipping-manager:fields/kg/search',
